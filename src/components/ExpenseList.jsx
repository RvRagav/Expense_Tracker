        ...
        <div >
            ...
            <ul  className="list-group">
                {expenses.map((expense) => (
                    <li key={expense.id} className="list-group-item d-flex justify-content-between align-items-center mb-2 mx-auto w-75">
            ...
            <div className="text-center m-4">
                <button className="btn btn-primary m-2 w-25" onClick={() => setExpenses([])}>Clear Expenses</button>
